...
clear @s sniffer_spawn_egg
clear @s snow_golem_spawn_egg
clear @s spider_spawn_egg
clear @s squid_spawn_egg
clear @s stray_spawn_egg
clear @s strider_spawn_egg
clear @s tadpole_spawn_egg
clear @s trader_llama_spawn_egg
...
clear @s zombified_piglin_spawn_egg
...
advancement revoke @s from build_battle:inventory